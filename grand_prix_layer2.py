...
COLOR_PRIORITY = (RED, RED2, GREEN, BLUE)
...
def update():
    ...
    if rc.controller.is_down(rc.controller.Button.X):
        COLOR_PRIORITY = [RED, RED2, BLUE, GREEN]
        print("COLOR_PRIORITY = [RED, BLUE, GREEN]")
    if rc.controller.is_down(rc.controller.Button.Y):
        COLOR_PRIORITY = [GREEN, BLUE, RED, RED2]
        print("COLOR_PRIORITY = [GREEN, BLUE, RED]")
    a, b = rc.controller.get_joystick(rc.controller.Joystick.RIGHT)
    if a != 0:
        print("COLOR_PRIORITY = [GREEN, RED, BLUE]")
        COLOR_PRIORITY = [GREEN, RED, RED2, BLUE]
    if b != 0:
        print("COLOR_PRIORITY = [BLUE, RED, GREEN]")
        COLOR_PRIORITY = [BLUE, RED, RED2, GREEN]
    x, y = rc.controller.get_joystick(rc.controller.Joystick.LEFT)
    if x != 0:
        print("COLOR_PRIORITY = [BLUE, GREEN, RED]")
        COLOR_PRIORITY = [BLUE, GREEN, RED, RED2]
    if y != 0:
        print("COLOR_PRIORITY = [RED, GREEN, BLUE]")
        COLOR_PRIORITY = [RED, RED2, GREEN, BLUE]
